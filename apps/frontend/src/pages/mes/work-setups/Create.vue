    ...
    <div class="dashboard-content">
      <header class="page-header">
        <div>
          ...
          <h1>Nueva configuración de cliente</h1>
          <p class="subtitle">Asigna tipos de trabajo y posiciones para un cliente y producto.</p>
        </div>
...
async function loadOptions() {
  try {
    ...
    error.value = err.message || 'No se pudieron cargar las opciones del formulario'
  }
}
