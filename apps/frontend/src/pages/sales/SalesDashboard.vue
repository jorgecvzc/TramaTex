  ...
  <BaseDashboardPage :is-loading="isLoading">
    ...
    <template #sidebar>
        ...
        <div class="quick-links-vertical">
          <RouterLink to="/sales/tickets/new" class="admin-card clickable highlight">
            ...
            <div class="admin-card-info">
              <strong>Venta Directa (Ticket)</strong>
              <p>TPV táctil para mostrador</p>
            </div>
          </RouterLink>
          <RouterLink to="/sales/quotes/new" class="admin-card clickable mt-3">
            <span class="material-symbols-outlined text-secondary">add_notes</span>
            <div class="admin-card-info">
              <strong>Crear Presupuesto</strong>
              <p>Oferta formal a cliente</p>
            </div>
          </RouterLink>
        </div>
      </section>
      ...
      <section class="help-notice mt-10">
        ...
        <p class="help-text">
          Las gráficas de evolución de ventas y comparativa anual estarán disponibles en la versión v1.1 (Post-MVP).
        </p>
      </section>
    </template>
  </BaseDashboardPage>
