...
-- Description: Development/sample data for TramaTex
-- Date: 2026-04-14
...
-- ============================================================================
-- IAM — Admin user (idempotent, also seeded in 001)
-- Password: admin123
-- ============================================================================
...
-- ============================================================================
-- PRODUCT GROUPS (fixed UUIDs referenced by products.group_ids)
-- ============================================================================
...
-- PRODUCT VARIANTS
-- ============================================================================
-- FYR2020 (Camiseta Clásica MC — base_price 2.21 EUR)
...
-- Services (no-attribute default variants)
INSERT INTO product_variants (id, product_id, sku, status, attribute_values, is_active) VALUES
...
-- ============================================================================
-- SALES ORDERS (enum: IN_PREPARATION)
-- ============================================================================
...
VALUES
    ('c787e99d-a1ac-4377-b907-e59d74eb6b11', 'PED-2026-0002',
     ...
     'IN_PREPARATION', 26.50, 5.57, 32.07, 'Urgente')
ON CONFLICT DO NOTHING;
...
INSERT INTO positions (id, name, code, description, is_active) VALUES
    ('e2e2e2e2-0001-0001-0001-000000000001', 'Pecho Izquierdo', 'PI',  'Posición estándar pecho izquierdo', true),
    ('e2e2e2e2-0001-0001-0001-000000000002', 'Pecho Derecho',   'PD',  'Posición estándar pecho derecho',   true),
    ('e2e2e2e2-0001-0001-0001-000000000003', 'Espalda',         'ES',  'Posición centrada en espalda',      true),
    ('e2e2e2e2-0001-0001-0001-000000000004', 'Manga Izquierda', 'MI',  'Posición en manga izquierda',       true),
    ('e2e2e2e2-0001-0001-0001-000000000005', 'Manga Derecha',   'MD',  'Posición en manga derecha',         true),
    ('e2e2e2e2-0001-0001-0001-000000000006', 'Centrado Frontal','CF',  'Posición centrada en el frontal',   true),
    ('e2e2e2e2-0001-0001-0001-000000000007', 'Muslo Izquierdo', 'MUI', 'Posición en muslo izquierdo',       true),
    ('e2e2e2e2-0001-0001-0001-000000000008', 'Muslo Derecho',   'MUD', 'Posición en muslo derecho',         true)
ON CONFLICT DO NOTHING;
