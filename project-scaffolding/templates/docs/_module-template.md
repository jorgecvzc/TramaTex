# $MODULE_NAME - Development Checklist & Documentation Hub

**Bounded Context:** `$BOUNDED_CONTEXT`  
**Responsabilidad Principal:** `$MODULE_DESCRIPTION`  
...
- [ ] **1. Crear Estructura de Módulo:**
  - [ ] Backend: `apps/$BACKEND_NAME/internal/$MODULE_NAME/` (ej. `apps/tramatex-api/internal/$MODULE_NAME`)
  - [ ] Frontend: `apps/$FRONTEND_NAME/src/modules/$MODULE_NAME/` (si aplica, ej. `apps/frontend/src/modules/$MODULE_NAME`)
...
- [ ] **3. Crear Tarea de Sprint:**
  - [ ] Archivo de tarea creado en `docs/log/sprints/$SPRINT_ID/`
...
- [ ] Cobertura de tests cumple los objetivos de calidad (ej: ≥90% en Dominio crítico).
...
- [ ] **Actualizar Documentación Central:**
    - [ ] `$C2_CONTAINERS_DOC_PATH` (si hay cambios relevantes).
