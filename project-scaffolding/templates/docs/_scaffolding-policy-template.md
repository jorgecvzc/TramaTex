...
- ✅ Directorio `user-input-docs/` (entrada)
...
|---|---|---|
| Logs de sesión | **docs/log/session-log.md** | Para sesiones de trabajo activas o pausadas |
...
- Toda la documentación del proyecto (excepto `README.md` y `AGENTS.md`) DEBE residir en el directorio `docs/` bajo la subcarpeta apropiada.
