...
- ✅ CRUD Party funcional (frontend + tramatex-api integrados)
...
En **todas las fases**, el desarrollo frontend se realiza simultáneamente con el tramatex-api, siguiendo estos principios:

1. **Contratos primero**: tramatex-api expone APIs REST con contratos JSON claros
