...
- Desarrollo paralelo tramatex-api + frontend por una sola persona
...
- ✅ Login funcional (tramatex-api + frontend)
...
#### Épica 1: Party (Semanas 14-21, 64h - 2 meses)
...
**Semanas 16-19 (32h): Implementación tramatex-api**
...
**Hito 3 (Mes 5):** ✅ tramatex-api Party completo y testeado

#### Épica 2: Frontend Party (Semanas 22-25, 32h - 1 mes)
...
**Hito 4 (Mes 6):** ✅ CRUD Party completo (frontend + tramatex-api)

#### Épica 3: Producto (Semanas 26-32, 56h - 1.75 meses)

**Semanas 26-27 (16h): Diseño y tramatex-api**
...
#### Épica 4: Tarificación (Semanas 33-45, 108h - 3.25 meses)
...
**Semanas 36-40 (40h): Implementación tramatex-api (TDD estricto)**
...
#### Épica 5: Pedidos tramatex-api (Semanas 46-53, 64h - 2 meses)
...
**Hito 7 (Mes 13):** ✅ tramatex-api Pedidos completo

#### Épica 6: Frontend Pedidos (Semanas 54-60, 56h - 1.75 meses)
...
#### Épica 7: Generación Documentos (Semanas 61-67, 62h - 2 meses)
...
#### Épica 8: MES tramatex-api (Semanas 68-74, 56h - 1.75 meses)
...
**Hito 10 (Mes 19):** ✅ tramatex-api MES completo

#### Épica 9: Gestión Documental (Semanas 75-78, 32h - 1 mes)
...
#### Épica 10: Terminal Taller (Semanas 79-86, 68h - 2.25 meses)
...
**Hito 3:** tramatex-api Party completo  
**Hito 4:** CRUD Party frontend + tramatex-api  
...
**Hito 7:** tramatex-api Pedidos completo  
...
**Hito 10:** tramatex-api MES completo  
...
- **Documentación de journals:** Carpeta `/docs/journals/` con un registro por bloque de trabajo.
...
### Opción A: 2 bloques de 4h (recomendada)

- **Bloque 1 (4h):** tramatex-api (dominio + tests)
- **Bloque 2 (4h):** Frontend o infraestructura

**Ventaja:** Permite cambio de contexto, reduce fatiga mental

### Opción B: 1 bloque de 8h

- **Domingo/Sábado (8h):** Sprint completo (tramatex-api + frontend)

**Ventaja:** Contexto continuo, menos overhead de setup

### Distribución de Tiempo Típica (por bloque de 8h)

```
[1.5h] Desarrollo con TDD (tests primero)
[1.5h] Implementación funcionalidad
[1.0h] Refactoring y optimización
[1.0h] Documentación (código, ADRs, bitácora)
...
## 10. Plantilla de Documentación de Journal

Cada semana, o al finalizar un bloque de trabajo, documentar en `/docs/journals/[ID]-[descripcion].md`:
