...
2. [x] **Ejecutar la refactorización de la estructura**:
   ...
   - [x] Archivar las sesiones antiguas en `docs/project/milestones`.
   - [x] Eliminar el antiguo directorio `docs/sessions`.
3. [x] **Actualizar toda la documentación y agentes del proyecto**:
   - [x] Actualizar la plantilla a `_JOURNAL_TEMPLATE.md`.
...
|---------|------|------------|
| `docs/journals/` | NEW | Nuevo directorio para los journals. |
| `docs/project/milestones/` | NEW | Directorio para archivar las sesiones antiguas. |
| `docs/sessions/` | DELETED | Directorio antiguo eliminado. |
| `docs/journals/_JOURNAL_TEMPLATE.md`| MOVED & MODIFIED | Plantilla actualizada al nuevo formato. |
...
| `agents/tramatex/project-context.yaml`| MODIFIED | Contexto de proyecto actualizado. |
...
| `docs/adr/ADR-008-planificacion-cronograma-mvp.md` | MODIFIED | ADR-008 actualizado. |
| `docs/adr/ADR-009-estructura-proyecto.md` | MODIFIED | ADR-009 actualizado. |
| `docs/project/sprints/sprint-02/refactorizacion-bitacora-de-desarrollo.md` | NEW | Este mismo journal. |
