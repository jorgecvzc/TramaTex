...
2. [ ] **Registro de Deuda Técnica** (1 hora)
   - [ ] Crear documento central: `/docs/engineering/technical-debt.md`
...
**Archivo a crear:** `docs/engineering/architecture/adr/ADR-010-estrategia-testing-coverage.md`
