...
- Renderizado de PDFs en tramatex-api  
...
### Lenguaje y tramatex-api

Se selecciona **Go (Golang)** como lenguaje principal del tramatex-api.
...
- Evita dependencias pesadas de renderizado en tramatex-api  
- Garantiza compatibilidad con hardware limitado  
- Permite usar estándares web (HTML + CSS Media Queries)  
- El tramatex-api se limita a exponer datos estructurados y contratos claros  
...
- tramatex-api predecible y fácil de operar  
...
- Relación tramatex-api ↔ frontend  
