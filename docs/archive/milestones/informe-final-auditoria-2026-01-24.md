...
Se corrigieron 18 referencias rotas en los siguientes archivos para que apuntaran a la nueva estructura de directorios (`docs/engineering/`, `docs/project/`, etc.):
