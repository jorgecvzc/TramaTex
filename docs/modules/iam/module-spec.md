...
*   **RNF-004 (Seguridad):** El endpoint de login debe aplicar rate limiting por IP.
*   **RNF-005 (Seguridad):** Logout debe invalidar tokens revocados (blacklist persistente).
...
- Gestión avanzada de políticas de contraseñas.
 - Gestión avanzada de permisos por recurso (ACLs finas).

### 2.3. Roles Definidos (MVP)

Roles oficiales del sistema en el MVP:

- **admin**: Administración completa.
- **commercial**: Gestión comercial (ventas, clientes, operaciones de negocio).
- **designer**: Diseño y preparación de pedidos personalizados.
- **workshop**: Operaciones de taller/producción.

**Rol por defecto:** `commercial` para usuarios registrados.
